...
mix_cols<-c("#26466D","#BBBBBB","#D73027")
names(mix_cols)<-c("Monoculture", "No_data","Mixed")
...
## Figure 3 ####
## figure making
source("Graphs/Figure_3_revised.R")

# figure output
w=10 ; h=8
ggsave("outputs/main_figure_3_revised.png",figure,dpi=600,width=w,height=h,units="cm")
ggsave("outputs/main_figure_3_revised.pdf",figure,dpi=600,width=w/2.54,height=h/2.54)
...
source("Graphs/Supplementary_Figure_09_new.R")

# figure output
# w=24 ; h=8
w=12 ; h=18
ggsave("outputs/supplementary_figure_09_new.png",figure,dpi=600,width=w,height=h,units="cm")
ggsave("outputs/supplementary_figure_09_new.pdf",figure,dpi=600,width=w/2.54,height=h/2.54)
...
source("Graphs/Supplementary_Figure_12_revised.R")
...
source("Graphs/Supplementary_Figure_13_revised.R")
...
source("Graphs/Model_BAI_replacing_TRW.R")
source("Graphs/Age_vs_mixture.R")
