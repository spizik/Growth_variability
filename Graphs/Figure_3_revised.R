...
print(concurvity(calc.model(prepare.data(df.crn, abal_mod_dataset, "ABAL", c(1961:2017))), full = TRUE))
print(concurvity(calc.model(prepare.data(df.crn, pcab_mod_dataset, "PCAB", c(1961:2017))), full = TRUE))
print(concurvity(calc.model(prepare.data(df.crn, pisy_mod_dataset, "PISY", c(1961:2017))), full = TRUE))
print(concurvity(calc.model(prepare.data(df.crn, fasy_mod_dataset, "FASY", c(1961:2017))), full = TRUE))
print(concurvity(calc.model(prepare.data(df.crn, qusp_mod_dataset, "QUSP", c(1961:2017))), full = TRUE))
